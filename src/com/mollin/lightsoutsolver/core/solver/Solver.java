...
public class Solver {
    ...
    public Solver(GridInterface startGrid, PatternInterface pattern) {
        this(startGrid, generateAllActiveGrid(startGrid), pattern);
    }
    ...
    /**
     * Génère une grille de taille identique à celle donnée en paramètre ayant
     * toutes ses cases actives.
     *
     * @param toCopy Grille à copier
     * @return La grille de taille identique à la grille à copier avec toutes
     * ses cases actives
     */
    private static GridInterface generateAllActiveGrid(GridInterface toCopy) {
